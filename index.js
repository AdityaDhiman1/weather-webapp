...
let url = " http://api.openweathermap.org/data/2.5/weather?q=dubai&appid=0ea1b7b6522241387b4273c637341072";
...
app.listen(3000, () => {
    console.log(chalk.inverse.bold.bgYellow("Server has been started at port 3000"))
})
